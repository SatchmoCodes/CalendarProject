...
export function generateQuestion() {
    ...
    choices[choiceArray[0]].setAttribute('onclick', 'answer(this)')
...
export function answer(i) {
    ...
    generatebtn.setAttribute('onclick', 'generateQuestion()')
